    ...
    def find_prefix_words(self, prefix):
       ...
       *      c      t          a   e
        ...
        for letter in prefix:
            found = False
            # traverse trie for each letter of prefix
            # stop at the last letter of prefix.
            for child in node.children:
                if child is not TrieNode.COMPLETE_WORD and child.data == letter:
                    found = child
                    break
        ...
        # get all the suffixes for the last node representing the last
        # letter of prefix
        ends = node.find_child_words()

        # make all the words possible for the prefix
        return [prefix + end for end in ends]
...
if __name__ == '__main__':
    ...
    # print  trie_node
    # trie_node = trie.root
    # trie_node.find_child_words()
     # ['a', 'ace', 'act', 'ate', 'bat', 'be', 'bet']



    # >>> trie
    # <__main__.Trie object at 0x6ffffe35210>
    # >>> trie.root
    # <__main__.TrieNode object at 0x6ffffe352d0>
    # >>> trie.root.find_child_words()
    # ['a', 'ace', 'act', 'ate', 'bat', 'be', 'bet']
    # >>> trie.root.children
    # [<__main__.TrieNode object at 0x6ffffe35390>, <__main__.TrieNode object at 0x6ffffe35510>]
    # >>> trie.root.children[0].data
    # 'a'
    # >>> trie.root.children[0].find_child_words()
    # ['', 'ce', 'ct', 'te']

    # >>> trie.root.children[0].children[0]
    # <object object at 0x6fffff160b0>
    # >>> trie.root.children[0].children[1]
    # <__main__.TrieNode object at 0x6ffffe353d0>
    # >>> trie.root.children[0].children[1].data
    # 'c'
    # >>> trie.root.children[0].children[1].find_child_words()
    # ['e', 't']
    # import timeit
    # print timeit.timeit("(trie.find_prefix_words('b'))", setup="from __main__ import Trie, trie", number=1000000)
